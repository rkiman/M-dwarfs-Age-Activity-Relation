...
spt_n1 = ['F0','F0.1','F0.2','F0.3','F0.4','F0.5','F0.6','F0.7','F0.8','F0.9',
          ...
          'L0','L0.1','L0.2','L0.3','L0.4','L0.5','L0.6','L0.7','L0.8','L0.9',
          'L1','L1.1','L1.2','L1.3','L1.4','L1.5','L1.6','L1.7','L1.8','L1.9',
          'L2','L2.1','L2.2','L2.3','L2.4','L2.5','L2.6','L2.7','L2.8','L2.9',
          'L3','L3.1','L3.2','L3.3','L3.4','L3.5','L3.6','L3.7','L3.8','L3.9',
          'L4','L4.1','L4.2','L4.3','L4.4','L4.5','L4.6','L4.7','L4.8','L4.9',
          'L5','L5.1','L5.2','L5.3','L5.4','L5.5','L5.6','L5.7','L5.8','L5.9',
          'L6','L6.1','L6.2','L6.3','L6.4','L6.5','L6.6','L6.7','L6.8','L6.9',
          'L7','L7.1','L7.2','L7.3','L7.4','L7.5','L7.6','L7.7','L7.8','L7.9',
          'L8','L8.1','L8.2','L8.3','L8.4','L8.5','L8.6','L8.7','L8.8','L8.9',
          'L9','L9.1','L9.2','L9.3','L9.4','L9.5','L9.6','L9.7','L9.8','L9.9']

spt_list_num1 = np.arange(-300,200)/10
...
spt_n43 = ['G0V ','G0.5V ','G1V ','G1.5V ','G2V ','G2.5V ','G3V ','G3.5V ',
          'G4V ','G4.5V ','G5V ','G5.5V ','G6V ','G6.5V ','G7V ','G7.5V ',
          'G8V ','G8.5V ','G9V ','G9.5V ',
          'K0V ','K0.5V ','K1V ','K1.5V ','K2V ','K2.5V ','K3V ','K3.5V ',
          'K4V ','K4.5V ','K5V ','K5.5V ','K6V ','K6.5V ','K7V ','K7.5V ',
          'K8V ','K8.5V ','K9V ','K9.5V ',
          'M0V ','M0.5V ','M1V ','M1.5V ','M2V ','M2.5V ','M3V ','M3.5V ',
          'M4V ','M4.5V ','M5V ','M5.5V ','M6V ','M6.5V ','M7V ','M7.5V ',
          'M8V ','M8.5V ','M9V ','M9.5V ']

spt_list_num43 = np.arange(-40,20)/2
